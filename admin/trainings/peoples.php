...
<!--                         <div class="col-4 text-center"><a href="order.php?id=<?=$order['id']?>" class="btn"><i class="fas fa-eye"></i></a></div>
 -->                        <div class="col-4 text-center"><a href="peoples.php?move=del&id=<?=$worker['id']?>" class="btn"><i class="fas fa-trash-alt"></i></a></div>
                        <div class="col-4 text-center"><a href="edit_worker.php?id=<?=$worker['id']?>" class="btn"><i class="fas fa-edit"></i></a></div>
                      </div>
                    </td>
