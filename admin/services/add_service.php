...
<div class="alert alert-success alert-dismissible">
  ...
  <h5><i class="icon fas fa-check"></i> Сервис успешно добавлен!</h5>
</div>
<?php
  }
 ?>
          ...
          <div class="card card-primary">
            <form action="#" method="POST">
              <div class="card-body">
                ...
                <button type="submit" class="btn btn-block btn-success btn-lg" name="add_button">Добавить сервис</button>
              </div>
